...
namespace Inventory_Management__System {
    ...
    public partial class dbMSDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductRow AddProductRow(int id, string code, string name, int quantity, int price, string supplier) {
...
namespace Inventory_Management__System.dbMSDataSet1TableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Product] WHERE (([id] = @Original_id) AND ([code] = @Original_code) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ([supplier] = @Original_supplier))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([id], [code], [name], [quantity], [price], [supplier" +
                "]) VALUES (@id, @code, @name, @quantity, @price, @supplier);\r\nSELECT id, code, n" +
                "ame, quantity, price, supplier FROM Product WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [id] = @id, [code] = @code, [name] = @name, [quantity] = @quantity, [price] = @price, [supplier] = @supplier WHERE (([id] = @Original_id) AND ([code] = @Original_code) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ([supplier] = @Original_supplier));
SELECT id, code, name, quantity, price, supplier FROM Product WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, code, name, quantity, price, supplier FROM dbo.Product";
        ...
        public virtual int Fill(dbMSDataSet1.ProductDataTable dataTable) {
        ...
        public virtual dbMSDataSet1.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbMSDataSet1.ProductDataTable dataTable = new dbMSDataSet1.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbMSDataSet1.ProductDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_code, string Original_name, global::System.Nullable<int> Original_quantity, global::System.Nullable<int> Original_price, string Original_supplier) {
        ...
        public virtual int Insert(int id, string code, string name, global::System.Nullable<int> quantity, global::System.Nullable<int> price, string supplier) {
        ...
        public virtual int Update(int id, string code, string name, global::System.Nullable<int> quantity, global::System.Nullable<int> price, string supplier, int Original_id, string Original_code, string Original_name, global::System.Nullable<int> Original_quantity, global::System.Nullable<int> Original_price, string Original_supplier) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string code, string name, global::System.Nullable<int> quantity, global::System.Nullable<int> price, string supplier, int Original_id, string Original_code, string Original_name, global::System.Nullable<int> Original_quantity, global::System.Nullable<int> Original_price, string Original_supplier) {
            return this.Update(Original_id, code, name, quantity, price, supplier, Original_id, Original_code, Original_name, Original_quantity, Original_price, Original_supplier);
        }
    }
