...
namespace Inventory_Management__System {
    ...
    public partial class dbMSDataSet2 : global::System.Data.DataSet {
        ...
        public partial class SupplierDataTable : global::System.Data.TypedTableBase<SupplierRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SupplierRow AddSupplierRow(int Sup_ID, string Name, string Address, int Phone) {
...
namespace Inventory_Management__System.dbMSDataSet2TableAdapters {
    ...
    public partial class SupplierTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Supplier] WHERE (([Sup_ID] = @Original_Sup_ID) AND ([Name] = @" +
                "Original_Name) AND ([Address] = @Original_Address) AND ([Phone] = @Original_Phon" +
                "e))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Supplier] ([Sup_ID], [Name], [Address], [Phone]) VALUES (@Sup_" +
                "ID, @Name, @Address, @Phone);\r\nSELECT Sup_ID, Name, Address, Phone FROM Supplier" +
                " WHERE (Sup_ID = @Sup_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Supplier] SET [Sup_ID] = @Sup_ID, [Name] = @Name, [Address] = @Address, [Phone] = @Phone WHERE (([Sup_ID] = @Original_Sup_ID) AND ([Name] = @Original_Name) AND ([Address] = @Original_Address) AND ([Phone] = @Original_Phone));
SELECT Sup_ID, Name, Address, Phone FROM Supplier WHERE (Sup_ID = @Sup_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Sup_ID, Name, Address, Phone FROM dbo.Supplier";
        ...
        public virtual int Fill(dbMSDataSet2.SupplierDataTable dataTable) {
        ...
        public virtual dbMSDataSet2.SupplierDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbMSDataSet2.SupplierDataTable dataTable = new dbMSDataSet2.SupplierDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbMSDataSet2.SupplierDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Sup_ID, string Original_Name, string Original_Address, int Original_Phone) {
        ...
        public virtual int Insert(int Sup_ID, string Name, string Address, int Phone) {
        ...
        public virtual int Update(int Sup_ID, string Name, string Address, int Phone, int Original_Sup_ID, string Original_Name, string Original_Address, int Original_Phone) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Address, int Phone, int Original_Sup_ID, string Original_Name, string Original_Address, int Original_Phone) {
            return this.Update(Original_Sup_ID, Name, Address, Phone, Original_Sup_ID, Original_Name, Original_Address, Original_Phone);
        }
    }
