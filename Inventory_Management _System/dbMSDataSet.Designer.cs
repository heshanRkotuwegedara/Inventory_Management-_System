...
namespace Inventory_Management__System.dbMSDataSetTableAdapters {
...
SELECT id, name, address, email, contact, username, password FROM Users WHERE (id = @id)";
        ...
        public virtual int Fill(dbMSDataSet.UsersDataTable dataTable) {
        ...
        public virtual dbMSDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbMSDataSet.UsersDataTable dataTable = new dbMSDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbMSDataSet.UsersDataTable dataTable) {
